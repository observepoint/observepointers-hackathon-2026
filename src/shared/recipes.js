...
const auditReportNetworkRequests = {
  ...
  steps: [
    ...
    {
      id: 'open-page-details',
      actor: 'user',
      navContext: '*',
      targetSelector: ANCHOR.pageDetailsPanel,
      say: 'Click into an Audit run, then click through to a single page. This is the Page Details view — everything ObservePoint recorded for that one URL.',
      completion: { type: 'dom_mutation', targetSelector: ANCHOR.pageDetailsPanel },
    },
    {
      id: 'tags-tab',
      actor: 'user',
